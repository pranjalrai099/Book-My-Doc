    ...
    <div>
      ...
      <div className='flex flex-col md:flex-row gap-12 my-10'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          <p>At Presticigo, we believe that managing healthcare should be simple, accessible, and stress-free. Our platform is designed to connect patients with healthcare professionals effortlessly, bringing quality healthcare closer to everyone. With just a few clicks, patients can find and book appointments with qualified doctors across various specialties, ensuring that they get the care they need when they need it.</p>
